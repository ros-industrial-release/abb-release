Name:           ros-melodic-abb-irb2400-support
Version:        1.3.1
Release:        1%{?dist}
Summary:        ROS abb_irb2400_support package
...
%description
ROS-Industrial support for the ABB IRB 2400 (and variants). This package
contains configuration data, 3D models and launch files for ABB IRB 2400
...
unqualified IRB 2400 model will be removed in ROS-Lunar, please use the IRB
2400-12/1.55 as a replacement.
